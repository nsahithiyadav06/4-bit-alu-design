...
##Switches
set_property -dict { PACKAGE_PIN D9    IOSTANDARD LVCMOS33 } [get_ports { B[0] }]; #IO_L12N_T1_MRCC_16 Sch=sw[0]
set_property -dict { PACKAGE_PIN C9   IOSTANDARD LVCMOS33 } [get_ports { B[1] }]; #IO_L13P_T2_MRCC_16 Sch=sw[1]
set_property -dict { PACKAGE_PIN B9   IOSTANDARD LVCMOS33 } [get_ports { B[2] }]; #IO_L13N_T2_MRCC_16 Sch=sw[2]
set_property -dict { PACKAGE_PIN B8   IOSTANDARD LVCMOS33 } [get_ports { B[3] }]; #IO_L14P_T2_SRCC_16 Sch=sw[3]

##Switches
set_property -dict { PACKAGE_PIN C7    IOSTANDARD LVCMOS33 } [get_ports { operation[0] }]; #IO_L12N_T1_MRCC_16 Sch=sw[0]
set_property -dict { PACKAGE_PIN A9   IOSTANDARD LVCMOS33 } [get_ports { operation[1] }]; #IO_L13P_T2_MRCC_16 Sch=sw[1]
set_property -dict { PACKAGE_PIN D10   IOSTANDARD LVCMOS33 } [get_ports { operation[2] }]; #IO_L13N_T2_MRCC_16 Sch=sw[2]



## RGB LEDs
##set_property -dict { PACKAGE_PIN E1    IOSTANDARD LVCMOS33 } [get_ports { led0_r }]; #IO_L18N_T2_35 Sch=led0_b
##set_property -dict { PACKAGE_PIN F6    IOSTANDARD LVCMOS33 } [get_ports { led0_b }]; #IO_L19N_T3_VREF_35 Sch=led0_g
